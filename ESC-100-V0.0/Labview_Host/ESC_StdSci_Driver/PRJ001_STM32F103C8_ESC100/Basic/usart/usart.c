...
// USART1 configuration
   void USART1_Init(u32 baud, FunctionalState IntState)
   { 
...
//   ............................................................................
//   USART1_TX
     GPIO_InitStructure.GPIO_Pin = USART1_TX_GpioPin;      //
     GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
     GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;        //Push-Pull AF
     GPIO_Init(USART1_TX_GpioPort, &GPIO_InitStructure);  
      	 
//   USART1_RX
     GPIO_InitStructure.GPIO_Pin = USART1_RX_GpioPin;      //
     GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;  //floating input
     GPIO_Init(USART1_RX_GpioPort, &GPIO_InitStructure);
...
//   ............................................................................
     ...
     NVIC_Init(&NVIC_InitStructure);	                         // 使能
...
void USART1_IRQHandler(void) //串口1中断服务程序（固定的函数名不能修改）
{
  ...
  if(USART_GetFlagStatus(USART1,USART_FLAG_RXNE) != RESET) //查询串口寄存器是否非空
    {
