...
#ifndef __ESC_BLDCM_MISC_H
#define __ESC_BLDCM_MISC_H
...
void bldc_motor_iq_ref_ramp(BLDCM_Controller* motor_ptr);
void bldc_motor_speed_ref_ramp(BLDCM_Controller* motor_ptr);
void bldc_motor_init_current_control_pid (BLDCM_Controller* motor_ptr);
void bldc_motor_init_parameters(BLDCM_Controller* motor_ptr);
//PAC5XXX_RAMFUNC fix16_t HertzToTicks(int Hertz, fix16_t Freq);
//PAC5XXX_RAMFUNC void get_curent_adc_value(BLDCM_Controller* motor_ptr);
