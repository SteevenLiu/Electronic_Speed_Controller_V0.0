...
#include "ESC_BLDCM_BASIC.h"
 	 	 	 	 	 	 	 	 	   ...
 	 	 	 	 	 	 	 	 	   //      V     W     W     U     U     V
//static const u8 pwm_io_state[7] = { 0, 0x02, 0x04, 0x04, 0x01, 0x01, 0x02 };  // H-bridge low-side driver(PA0¡¢PA1¡¢PA2) output high in GPIO mode
...
//static const u16 psel_mask_port_a[7] = { 0, 0x0080, 0x0080, 0x0100,  0x0100 ,0x0400, 0x0400};  // H-bridge driver just high-side use PWM mode
...
{	
  TIM_SetCompare1(TIM8,temp_pwm_duty);  //U
	TIM_SetCompare2(TIM8,temp_pwm_duty);  //V
	TIM_SetCompare3(TIM8,temp_pwm_duty);  //W
}
...
{
  TIM_SetCompare1(TIM8,u_temp_pwm_duty);  //U
	TIM_SetCompare2(TIM8,v_temp_pwm_duty);  //V
	TIM_SetCompare3(TIM8,w_temp_pwm_duty);  //W
}
...
// Set pwm duty variable to zero, disable all PWM outputs and clear close loop status
   TIM_SetCompare1(TIM8,0);  //U
	 TIM_SetCompare2(TIM8,0);  //V
	 TIM_SetCompare3(TIM8,0);  //W	
...
// .........................................................
   ...
   TIM_ForcedOC3Config(TIM8,TIM_ForcedAction_InActive);
