...
// pac5xxx_timer_io_select_pwma6_pa5();	// WH
	...
	NVIC_SetPriority(GpioB_IRQn, 0);											// Set priority to 0
...
void cafe_init(void)
{
    ...
    pac5xxx_tile_register_write(0x15, 0xC0);                        // CFGPWR0: enable dc/dc, set vp to 12V
	...
	pac5xxx_tile_register_write(ADDR_CFGAIO7, 0x40);		   		// MODE7[1:0] = 11b (special mode), OPT7[1:0] = 01b (AB1 as COMP-), POL7 = 0 (act high), MUX[2:0] = n/a
	pac5xxx_tile_register_write(ADDR_CFGAIO8, 0x40);		   		// MODE8[1:0] = 11b (special mode), OPT8[1:0] = 01b (bypass FF, select MUX out for nIRQ2/POS), POL8 = 0 (act high), MUX[2:0] = n/a
	pac5xxx_tile_register_write(ADDR_CFGAIO9, 0x40); 		// MODE9[1:0] = 01b (CT Vfilt), OPT9[1:0] = 0bxx (AIO7), POL9 = 0 (act high), MUX[2:0] = n/a
#else
	//Configure Sensorless Comparators
